    ...
    <div className="bg-black text-white min-h-screen pt-24 pb-20">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="space-y-12">
          ...
          <div>
            <h2 className="text-xl uppercase tracking-widest mb-6 text-white/80">Orders & Shipping</h2>
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-1" className="border-white/20 bg-zinc-950 px-6">
                <AccordionTrigger className="hover:no-underline hover:text-white transition-colors text-left">Do you ship worldwide?</AccordionTrigger>
              ...
              <AccordionItem value="item-2" className="border-white/20 bg-zinc-950 px-6">
                <AccordionTrigger className="hover:no-underline hover:text-white transition-colors text-left">How long will my order take?</AccordionTrigger>
                <AccordionContent className="text-white/60 font-light leading-relaxed">
              ...
              <AccordionItem value="item-3" className="border-white/20 bg-zinc-950 px-6">
                <AccordionTrigger className="hover:no-underline hover:text-white transition-colors text-left">What is your return policy?</AccordionTrigger>
                <AccordionContent className="text-white/60 font-light leading-relaxed">
          ...
          <div>
            <h2 className="text-xl uppercase tracking-widest mb-6 text-white/80">Custom Grillz</h2>
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-4" className="border-white/20 bg-zinc-950 px-6">
                <AccordionTrigger className="hover:no-underline hover:text-white transition-colors text-left">How do I get my mold done?</AccordionTrigger>
                <AccordionContent className="text-white/60 font-light leading-relaxed">
              ...
              <AccordionItem value="item-5" className="border-white/20 bg-zinc-950 px-6">
                <AccordionTrigger className="hover:no-underline hover:text-white transition-colors text-left">What karat gold do you use?</AccordionTrigger>
                <AccordionContent className="text-white/60 font-light leading-relaxed">
