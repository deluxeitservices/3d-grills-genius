        ...
        <div className="space-y-12 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-white/70 font-light leading-relaxed text-lg">
              Aura Jewellery was born out of a desire to bridge the gap between traditional fine jewelry and modern urban culture. We observed a landscape filled with mass-produced pieces lacking soul and decided to build a brand focused entirely on bespoke craftsmanship and uncompromising quality.
            </p>
          </div>
