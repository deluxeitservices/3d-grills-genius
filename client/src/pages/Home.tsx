        ...
        <div className="container mx-auto px-4 md:px-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 max-w-6xl mx-auto">
            {[
              ...
              {
                text: "The process was super easy, and the result was even better than I expected! My custom grillz fit perfectly, feel amazing, and have the perfect shine. ZA JEWELLERS made sure I was happy with every detail. Totally worth it!",
                author: "Marcus L."
              }
            ].map((review, i) => (
