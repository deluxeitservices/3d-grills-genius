...
export async function autoSeed() {
  ...
  const prodImageMap: Record<string, string[]> = {
    "hello-kitty-heart-set": ["/assets/prod-hello-kitty.png"],
    "window-and-heart-cap": ["/assets/prod-window-heart.png"],
    "sparkle-window-grillz-set": ["/assets/prod-sparkle-window.png"],
    "london-bridge-design": ["/assets/prod-london-bridge.png"],
    "classic-gold-single-tooth-cap": ["/assets/prod-classic-gold.png"],
    "diamond-dust-bottom-6": ["/assets/prod-diamond-dust.png"],
    "rose-gold-fangs-set": ["/assets/prod-rose-gold-fangs.png"],
    "iced-out-full-set": ["/assets/prod-iced-out.png"],
    "swarovski-crystal-tooth-gem": ["/assets/prod-swarovski-gem.png"],
    "premium-mould-kit": ["/assets/prod-mould-kit.png"],
    "rainbow-chrome-top-4": ["/assets/prod-rainbow-chrome.png"],
    "solid-gold-bottom-8-bar": ["/assets/prod-gold-bottom-bar.png"],
  };
  ...
  if (existingProds.length === 0) {
    prods = await db.insert(products).values([
    {
      ...
      images: ["/assets/prod-hello-kitty.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-window-heart.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-sparkle-window.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-london-bridge.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-classic-gold.png"],
      categoryId: catBySlug("single-grillz")?.id,
      quantity: 50,
      shippingCharges: "10.00",
      taxPercentage: "20.00",
    ...
    },
    {
      ...
      images: ["/assets/prod-diamond-dust.png"],
      categoryId: catBySlug("diamond-grillz")?.id,
      quantity: 8,
      isActive: true,
      isFeatured: false,
    ...
    },
    {
      ...
      images: ["/assets/prod-rose-gold-fangs.png"],
      categoryId: catBySlug("curves-colour")?.id,
      quantity: 20,
      isActive: true,
      isFeatured: true,
    ...
    },
    {
      ...
      images: ["/assets/prod-iced-out.png"],
      categoryId: catBySlug("diamond-grillz")?.id,
      quantity: 5,
      isActive: true,
      isFeatured: true,
    ...
    },
    {
      ...
      images: ["/assets/prod-swarovski-gem.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-mould-kit.png"],
    ...
    },
    {
      ...
      images: ["/assets/prod-rainbow-chrome.png"],
      categoryId: catBySlug("curves-colour")?.id,
      quantity: 10,
      isActive: true,
      isFeatured: false,
    ...
    },
    {
      ...
      images: ["/assets/prod-gold-bottom-bar.png"],
      categoryId: catBySlug("gold-set-grillz")?.id,
      quantity: 7,
      isActive: true,
      isFeatured: false,
